...
def _canned_response(_payload, adapter=None, store=None, provider=None) -> SearchExecuteResponse:
...
def test_search_execute_retrieval_error_returns_service_error(
    ...
    def raise_retrieval_error(_payload, adapter=None, store=None, provider=None):
